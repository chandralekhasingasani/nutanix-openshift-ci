...
function send_kubeconfig_slack()
{
  ...
  if [ -f $path_kubeconfig_file ];then
      curl -F file=@binary/auth/kubeconfig -F "initial_comment=Here is the Kubeconfig file , INSTALLER_BRANCH=$INSTALLER_BRANCH and RELEASE_IMAGE=${RELEASE_IMAGE}" -F channels=C01UE7XQ95E -H "Authorization: Bearer xoxb-2172428722-3547239687975-JqvTUzCcpB8ULNs70i4RKJk8" https://slack.com/api/files.upload
